...
unsigned char curSentenceType = GPS_SENTENCE_OTHER;
unsigned char curTermNumber = 0;
unsigned char curTermOffset = 0;
...
int main(){
    ...
    char klee_input_buffer[47];

    klee_make_symbolic(klee_input_buffer,
                       sizeof(klee_input_buffer),
                       "gps_nmea_stream");

    input_buffer = klee_input_buffer;
