...
long bouncer_state;
unsigned char signals[] = {0b00000001, 0b00000001, 0b00000000, 0b00000010, 0b00000011, 0b00000000, 0b00000000, 0b00000001, 0b00000011, 0b00000011, 0b00000001, 0b00000010, 0b00000010, 0b00000000};
int sig_len = 14;
int sig_idx = 0;

// Lets emulate the bouncer
const unsigned char DEBOUNCED_STATE = 0b00000001;
const unsigned char UNSTABLE_STATE = 0b00000010;
const unsigned char CHANGED_STATE = 0b00000100;

void setStateFlag(const unsigned char flag) {
    bouncer_state |= flag;
}

void unsetStateFlag(const unsigned char flag) {
    bouncer_state &= ~flag;
}

void toggleStateFlag(const unsigned char flag) {
    bouncer_state ^= flag;
}

long getStateFlag(const unsigned char flag) {
